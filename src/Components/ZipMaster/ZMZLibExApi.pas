...
//function get_crc_table: pointer; external;
...
//{$ifdef WIN64}
function zmemzero(p: Pointer; count: Integer): Pointer; cdecl;
begin
  FillChar(p^, count, 0);
...
procedure zmemcpy(dest, source: Pointer; count: Integer); cdecl;
begin
  Move(source^, dest^, count);
end;
//{$endif}
